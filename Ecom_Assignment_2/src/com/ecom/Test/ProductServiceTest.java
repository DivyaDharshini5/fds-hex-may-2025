...
public class ProductServiceTest {
    ...
    public void testInsertProduct() {
        // Use Case 1: Insert validation product - should not throw exception
    ...
    public void testGetByCategoryId() {
        ...
        assertDoesNotThrow(() -> productService.getByCategoryId(1, product));
    ...
    public void testGetById() {
        ...
        assertDoesNotThrow(() -> productService.getById(63488));
