...
public class PurchaseServiceTest {
    ...
    public void testInsertProduct() {
        // Use Case 1: Insert
    	//validating prdoct insertion- should not throw exception
    ...
    public void testGetByCategoryId() {
        // Use Case 4: Valid category ID and product - 
        ...
        // Use Case 5: Negative category ID -
        //should throw (product show not have negative values)
        Product product2 = new Product(102, "Washing Machine", 25000.0, -1, category);
        ...
        // Use Case 6: Null product for category ID - 
        //should throw Exception category_id should not be null
        assertThrows(RuntimeException.class, () -> {
            productService.getByCategoryId(887554, null);
        });
    }
    ...
    public void testGetById() {
        ...
        assertDoesNotThrow(() -> productService.getById(101));
