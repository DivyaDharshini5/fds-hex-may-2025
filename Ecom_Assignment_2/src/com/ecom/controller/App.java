...
public static void main(String[] args) {
	...
	while(true) {
		System.out.println("--------------Ecommerce Menu List---------------");
		System.out.println("1.Add customer");
		System.out.println("2.GetAll customer");
		System.out.println("3.Add Category");
		System.out.println("4.Add Product");
		System.out.println("5.GetCustomer by ID");
		System.out.println("6.Getproduct by ID");
		System.out.println("7.getall category");
		System.out.println("8.GetAll product");
